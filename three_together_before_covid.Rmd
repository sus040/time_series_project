...
plot(data_ts, main = "Time Series of S&P 500, Coupon Rates, and Gold Prices")
```
...
fit <- auto.arima(gold_ts, xreg = regressor)
...
ggplot(combined_data, aes(x = date, y = gold, group = Type, color = Type)) +
  ...
  labs(title = "Gold Price: Historical, Actual, and Forecast",
       x = "Date",
       y = "Price",
       color = "Data Type") +
  theme_minimal()
